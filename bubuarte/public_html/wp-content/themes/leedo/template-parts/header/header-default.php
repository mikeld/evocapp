				...
				<div class="vlt-navbar-inner">
					...
					<div class="vlt-navbar-inner--left">
						...
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="vlt-navbar-logo">
							<?php if ( leedo_get_theme_mod( 'header_default_logo' ) ) : ?>
								<img src="<?php echo leedo_get_theme_mod( 'header_default_logo' ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="black">
								<img src="<?php echo leedo_get_theme_mod( 'header_default_logo_white' ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="white">
							<?php else: ?>
