...
$footer_class = 'vlt-footer vlt-footer--style-1';
	...
	<div class="container">
		...
		<div class="text-center">
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="vlt-footer-logo">
				<?php if ( leedo_get_theme_mod( 'footer_style-1_logo' ) ) : ?>
					<img src="<?php echo leedo_get_theme_mod( 'footer_style-1_logo' ); ?>" alt="<?php bloginfo( 'name' ); ?>">
				<?php else: ?>
