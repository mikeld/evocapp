	...
	<div class="vlt-image-slider" data-dots="false" data-nav="true">
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide"><?php echo leedo_get_attachment_image_fit( get_post_thumbnail_id( get_the_ID() ), $size, array( '61%', '80%' ) ); ?></div>
				...
				<?php
					...
					if ( leedo_get_field( 'post_gallery_images' ) ) :
						...
						foreach( $images as $image ) :
							echo '<div class="swiper-slide">' . leedo_get_attachment_image_fit( $image['ID'], $size, array( '61%', '80%' ) ) . '</div>';
						endforeach;
