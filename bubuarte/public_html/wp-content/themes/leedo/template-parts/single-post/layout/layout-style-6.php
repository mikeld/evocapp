					...
					<?php
						if ( has_post_thumbnail() ) {
							switch( $format ) {
								...
								case 'quote':
								case 'audio':
									get_template_part( 'template-parts/single-post/media/media', 'simple-image' );
									break;
								case 'video':
									get_template_part( 'template-parts/single-post/media/media', 'simple-image-video' );
									break;
								case 'gallery':
									get_template_part( 'template-parts/single-post/media/media', 'simple-slider' );
									break;
							}
						}
					?>
